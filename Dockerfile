...
RUN wget https://github.com/OpenOrbis/OpenOrbis-PS4-Toolchain/releases/download/v0.5.2/toolchain-llvm-18.2.zip && unzip toolchain-llvm-18.2.zip && tar xf toolchain-llvm-18.tar.gz && mv OpenOrbis/PS4Toolchain /opt/openorbis && rm -r OpenOrbis toolchain-llvm-18.tar.gz toolchain-llvm-18.2.zip
